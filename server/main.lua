...
---@param netId number
RegisterNetEvent('tgiann-target:setEntityHasOptions', function(netId)
...
RegisterNetEvent('tgiann-target:toggleEntityDoor', function(netId, door)
    ...
    TriggerClientEvent('tgiann-target:toggleEntityDoor', owner, netId, door)
end)
...
CreateThread(function()
    ...
    while true do
        ...
        if num > 0 then
            TriggerClientEvent('tgiann-target:removeEntity', -1, arr)
            table.wipe(arr)
