if not require('client.utils.convar').bool('defaults', true) then return end
...
local function onSelectDoor(data, door)
    ...
    TriggerServerEvent('tgiann-target:toggleEntityDoor', VehToNet(entity), door)
end

RegisterNetEvent('tgiann-target:toggleEntityDoor', function(netId, door)
